    ...
    password: {
        ...
        validate(value) {
            if (value.toLowerCase().includes("password")) {
                throw new Error('you cant use "password" as your password, change it.')
            } 
        }
    },
    email: {
...
userSchema.statics.findByCredentials = async (email, password) => {
    ...
    if (!isMatch) {
        throw new Error('Unable to login, check your username or password.')
    }
...
//hash the plain password middleware
